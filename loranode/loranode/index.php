...
<body>
	<div class="content">
		<div class="row">
			...
			<a href="index.php"> <img
				src="asset/img/bannerdsvn.png" class="hidden-xs"
				style="width: 100%"> <img
				src="asset/img/bannerdsvn-mobile.png"
	...
	<div class="row">
		<div class="col-md-12" style="margin-top: 10px; padding: 5px">
			...
			<div class="boxHeader">
				...
				<a href="index.php"><span class="header1"
						...
						<div id="div1" class="row div-<?php echo $displayInfo['1']['3'];?>"
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								...
								<div id="divNumber" class="row text-center">
									<img id="pinIcon" src="<?php echo "asset/img/".$displayInfo['1']['2'] ?>" style="margin-bottom: 10px; float: left; margin-right: 10px;margin-left: 113px" width="70px" height="70px">
	...
	aria-hidden="true"></i> <span style="margin-left: 5px">Tàu
	: VN-001</span>
</div>
<div class="col-md-12 col-sm-12 col-xs-12"
style="text-align: left; margin-top: 10px"
	...
	<div class="col-md-6 col-sm-6 col-xs-6" style="padding: 0px;">
		<div class="col-md-12" style="margin-top: 5px; padding: 0px;">
			<div class="col-md-6 col-xs-6 col-sm-6 text-right">
				<img src="asset/img/icon_weather.png">
			</div>
...
<div class="col-md-6 col-sm-6 col-xs-6" style="padding: 0px;">
	<div class="col-md-12" style="padding: 0px; margin-top: 5px">
		<div class="col-md-6 col-xs-6 col-sm-6 text-right">
			<img src="asset/img/icon_water.png">
		</div>
		<div class="col-md-6 col-xs-6 col-sm-6 text-left"
		style="padding: 0px;">
		<p style="font-size: 20px;">
...
<div id="aqiNomal">
	<div class="row" style="margin-left: 30px; margin-bottom: 10px">
		...
		height="20" src="asset/img/info.jpg"
...
<div class="col-md-3 col-sm-3 col-xs-6" style="padding: 0px">
	...
	<option value="co"<?php if($commonChart['2'] == 'co') echo"selected"; ?>>Khí CO</option>
	<option value="co2"<?php if($commonChart['2'] == 'co2') echo"selected"; ?>>Khí CO2</option>
	<option value="ethanol" <?php if($commonChart['2'] == 'ethanol') echo"selected"; ?>>C2H5-OH</option>
	<option value="toluene" <?php if($commonChart['2'] == 'toluene') echo"selected"; ?>>C7H8</option>
	<option value="acetone" <?php if($commonChart['2'] == 'acetone') echo"selected"; ?>>C3H6O</option>
	<option value="temp" <?php if($commonChart['2'] == 'temp') echo"selected"; ?>>Nhiệt độ</option>
	<option value="humi" <?php if($commonChart['2'] == 'humi') echo"selected"; ?>>Độ ẩm</option>
...
canvas {
	...
	-ms-user-select: none;
												...
												<canvas id="canvas"
													style="margin-top: 10px; width: 100%; height: 100%;font-size: 20px;"></canvas>
											</div>
										</div>
									</div>
...
<footer class="footerCustom">
	<div class="container">
		<p class="textFooter">
			<img src="asset/img/logo_bk.png" width="25px">
